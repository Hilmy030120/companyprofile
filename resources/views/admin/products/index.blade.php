<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-row items-center justify-between">
            ...
            <a href="{{ route('admin.products.create') }}" class="px-6 py-4 font-bold text-white bg-indigo-700 rounded-full">
                Add New
            </a>
        </div>
    </x-slot>
            ...
            <div class="flex flex-col p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg gap-y-5">
                ...
                <div class="flex flex-row items-center justify-between item-card">
                    ...
                    <div class="flex-row items-center hidden md:flex gap-x-3">
                        <a href="{{ route('admin.products.edit', $product) }}" class="px-6 py-4 font-bold text-white bg-indigo-700 rounded-full">
                            Edit
                        </a>
