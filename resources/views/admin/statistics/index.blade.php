<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-row items-center justify-between">
            ...
            <a href="{{ route('admin.statistics.create') }}" class="px-6 py-4 font-bold text-white bg-indigo-700 rounded-full">
                Add New
            </a>
        </div>
    </x-slot>
            ...
            <div class="flex flex-col p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg gap-y-5">
                ...
                <div class="flex flex-row items-center justify-between item-card">
                    ...
                    <div  class="flex-col hidden md:flex">
                        ...
                        <h3 class="text-xl font-bold text-indigo-950">{{ $statistic->created_at->format('M d, Y') }}</h3>
                    </div>
                    <div class="flex-row items-center hidden md:flex gap-x-3">
                        <a href="{{ route('admin.statistics.edit', $statistic) }}" class="px-6 py-4 font-bold text-white bg-indigo-700 rounded-full">
                            Edit
                        </a>
