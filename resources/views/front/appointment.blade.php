      ...
      <div class="flex items-center gap-[18px]">
        <div class="flex flex-col w-full gap-2">
          ...
          <div class="flex items-center gap-[10px] p-[14px_20px] border border-[#E8EAF2] focus-within:border-cp-dark-blue transition-all duration-300 rounded-xl bg-white">
            ...
            <input type="text" name="name" id="" class="w-full font-semibold bg-white outline-none appearance-none placeholder:font-normal placeholder:text-cp-black" placeholder="Write your complete name" required>
          </div>
        </div>
        <div class="flex flex-col w-full gap-2">
          ...
          <div class="flex items-center gap-[10px] p-[14px_20px] border border-[#E8EAF2] focus-within:border-cp-dark-blue transition-all duration-300 rounded-xl bg-white">
            ...
            <input type="email" name="email" id="" class="w-full font-semibold bg-white outline-none appearance-none placeholder:font-normal placeholder:text-cp-black" placeholder="Write your email address" required>
          </div>
        </div>
      </div>
      <div class="flex items-center gap-[18px]">
        <div class="flex flex-col w-full gap-2">
          ...
          <div class="flex items-center gap-[10px] p-[14px_20px] border border-[#E8EAF2] focus-within:border-cp-dark-blue transition-all duration-300 rounded-xl bg-white">
            ...
            <input type="tel" name="phone_number" id="" class="w-full font-semibold bg-white outline-none appearance-none placeholder:font-normal placeholder:text-cp-black" placeholder="Write your phone number" required>
          </div>
        </div>
        <div class="flex flex-col w-full gap-2">
      ...
      <div class="flex items-center gap-[18px]">
        ...
        <div class="flex flex-col w-full gap-2">
          ...
          <div class="flex items-center gap-[10px] p-[14px_20px] border border-[#E8EAF2] focus-within:border-cp-dark-blue transition-all duration-300 rounded-xl bg-white">
            ...
            <input type="number" name="budget" id="" class="w-full font-semibold bg-white outline-none appearance-none placeholder:font-normal placeholder:text-cp-black" placeholder="What is your budget" required>
          </div>
        </div>
      </div>
      <div class="flex flex-col w-full gap-2">
        ...
        <div class="flex gap-[10px] p-[14px_20px] border border-[#E8EAF2] focus-within:border-cp-dark-blue transition-all duration-300 rounded-xl bg-white">
          ...
          <textarea name="brief" id="" rows="6" class="w-full font-semibold bg-white outline-none appearance-none resize-none placeholder:font-normal placeholder:text-cp-black" placeholder="Tell us the project brief"></textarea>
        </div>
      </div>
    ...
    <div class="w-full main-carousel">
      ...
      <div class="carousel-card container max-w-[1130px] w-full flex flex-wrap justify-between items-center lg:mx-[calc((100vw-1130px)/2)]">
            ...
            <div class="flex items-center justify-between pl-[30px]">
              <div class="flex items-center gap-6">
                <div class="w-[60px] h-[60px] flex shrink-0 rounded-full overflow-hidden">
                  <img src="{{ Storage::url($testimonial->client->avatar) }}" class="object-cover w-full h-full" alt="photo">
                </div>
        ...
        <div class="testimonial-thumbnail w-[470px] h-[550px] rounded-[20px] overflow-hidden bg-[#D9D9D9]">
          <img src="{{ Storage::url($testimonial->thumbnail) }}" class="object-cover object-center w-full h-full" alt="thumbnail">
        </div>
      </div>
      @empty
