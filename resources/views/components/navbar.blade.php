<nav class="flex flex-wrap items-center justify-between bg-white p-[20px_30px] rounded-[20px] gap-y-3">
    ...
    <ul class="flex flex-wrap items-center gap-[30px]">
      <li class="{{ request()->routeIs('front.index') ? 'text-cp-dark-blue' : '' }} font-semibold transition-all duration-300 hover:text-cp-dark-blue">
        <a href="{{ route('front.index') }}">Home</a>
      </li>
      <li class="font-semibold transition-all duration-300 hover:text-cp-dark-blue">
        <a href="">Products</a>
      </li>
      <li class="{{ request()->routeIs('front.team') ? 'text-cp-dark-blue' : '' }} font-semibold transition-all duration-300 hover:text-cp-dark-blue">
        <a href="{{ route('front.team') }}">Company</a>
      </li>
      <li class="font-semibold transition-all duration-300 hover:text-cp-dark-blue">
        <a href="">Blog</a>
      </li>
      <li class="{{ request()->routeIs('front.about') ? 'text-cp-dark-blue' : '' }} font-semibold transition-all duration-300 hover:text-cp-dark-blue">
